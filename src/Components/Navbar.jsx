...
export default function Navbar() {
    ...
    return (
        <Nav>
            <NavCont>
                <Logo onClick={()=> scroll.scrollToTop()}>AB</Logo>
                <Menu>
                    ...
                    <Resume> <a href="https://drive.google.com/drive/u/0/folders/1Qr0x6KTT8_3c-RcaGIprqW_t0mbZgBuu" target="_blank" rel="noopener noreferrer">Resume</a></Resume>
                </Menu>
            </NavCont>
        </Nav>
    )
